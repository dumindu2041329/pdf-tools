...
export const metadata: Metadata = {
  title: "Pricing",
  description:
    "Compare Free and Premium PDF Tools plans. See per-tool file limits, daily and monthly quotas, and unlock 4 GB uploads with Premium.",
}
    ...
    <div className="relative">
      ...
      <section className="relative overflow-hidden border-b border-border/40">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-12 sm:pt-24 sm:pb-16 text-center">
          ...
          <p className="mt-5 text-lg text-muted-foreground max-w-2xl mx-auto">
            Start free with generous limits. Upgrade to Premium for 4 GB uploads
            and unlimited processing.
          </p>
        </div>
      </section>

      {/* Plan cards */}
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 -mt-2 pb-16">
      ...
      <section className="border-t border-border/40">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Start free and upgrade only when you need bigger files or unlimited
            usage. Cancel anytime.
          </p>
          ...
          <p className="mt-8 text-xs text-muted-foreground">
            Limits shown reflect a single processing request. Premium also lifts
            the per-file size cap from 20 MB to 4 GB on every tool.
          </p>
        </div>
      </section>
