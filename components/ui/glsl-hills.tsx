...
const GLSLHills = ({ width = '100vw', height = '100vh', cameraZ = 125, planeSize = 256, speed = 0.5 }) => {
  ...
  useEffect(() => {
    ...
    // Instead of using window.innerWidth, use the container dimensions
    ...
    const camera = new THREE.PerspectiveCamera(45, getContainerWidth() / getContainerHeight(), 1, 10000);
    ...
    return () => {
      ...
      // @ts-expect-error Typescript doesn't strictly know about material.dispose on Mesh
